...
class PDFExtractor:
    ...
    def extract_specific_lines_from_pdf(self, page_number, lines_to_extract):
        print("def extract_specific_lines_from_pdf")
        try:
    ...
    def get_result_df(self):
        print("def get_result_df")
        return self.result_df

    def get_accounts_info(self):
        print("def get_accounts_info")
        return self.accounts_data
    
    def get_bill_date(self):
        print("def get_bill_date")
...
def save_upload_file_tmp(upload_file: UploadedFile) -> str:
    print("def save_upload_file_tmp")
...
class Model4(First, Model3):
    ...
    def process_pdf(self):
        ...
        columns_to_drop = [
            'User_name_y', 'Item Type', 'Share Description', 'Share Voice',
            'Share Messaging', 'Share Data', 'Allowance', 'Used', 'Billable',
            'Order Details', 'Bill Cycle Date', 'Invoice Number'
        ]

        # Filter only existing columns in the DataFrame
