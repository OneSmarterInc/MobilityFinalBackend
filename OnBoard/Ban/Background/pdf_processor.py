...
# from .scripts.t_mobile import get_all_dataframes
# from .scripts.t_mobile_second import extract_text_from_t_mobile
# batch_count = '000'
...
#         base_data_df,pdf_df,temp,rox,on,dates,acc_nos = get_all_dataframes(pdf_path)
...
#         print('got first')
#         print('>>>>>>>>>>>>><<<<<<<<<<<<<<>>>>>>>>>>>>><<<<<<<<<<<>>>>>>>>>>>')
#         base_data_df,pdf_df,tmp_df,in_valid_df,usage_df,dates,acc_nos = get_all_dataframes(pdf_path)
#         print('>>>>>>>>>>>>>>>qwertyui<<<<<<<<<<<<')
...
#     elif vendor_nm in t_mobile_list and types == 'second':
#         print('got second')
#         unique_df,base_data_df,detail_df = extract_text_from_t_mobile(pdf_path)
...
# def save_to_unique_pdf_data_table(data,vendor,types):
...
#             print('got here')
#             save_to_unique_pdf_data_table(unique_pdf_data,vendor_name,types)
